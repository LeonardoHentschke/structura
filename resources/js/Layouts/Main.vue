...
<template>
  <div class="flex flex-col min-h-screen">
        ...
        <div class="flex items-center space-x-4">
          ...
          <div v-if="user" class="flex items-center space-x-4">
            ...
            <Button class="user-profile-btn flex items-center space-x-2 cursor-pointer" :href="route('profile.edit')">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="user-icon w-6 h-6">
    ...
    <!-- Main content -->
    <main class="flex-grow p-6 mx-auto max-w-screen-lg flex items-center justify-center">
      <slot />
    </main>
